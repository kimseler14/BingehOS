...
* **Türk Takvimi:** Resmi tatiller, Dini bayramlar sisteme gömülü olmalı. Mesai, fazla mesai ve hafta tatili hesaplamaları otomatik yapılmalı.
...
> **Mekanizma / Seed Ayrımı:** `JobPlanTemplate` şablon **altyapısı (genel mekanizma ve `/job-plan-templates` endpoint'i) MVP (Doküman 03 + 07)'dir**. Bu bölümdeki **Türkiye'ye özgü önceden doldurulmuş (pre-seeded) ekipman şablonlarının SEED VERİSİ** (Asansör/Yangın/Jeneratör/HVAC) ise **Phase 2 / Turkey Compliance Pack** kapsamındadır.

Türkiye'de en çok kullanılan ekipmanlar için "Hazır Şablonlar" sistemde gömülü (Pre-seeded) olarak gelmelidir:
...
* **Kalibrasyon:** Test cihazları ve sensörler için kalibrasyon son geçerlilik tarihi takibi.
...
| Calibration Management | 03 / 05 + 07 | Compliance (CalibrationRecord) |
...
| Türk Takvimi (resmi tatil/dini bayram/mesai/fazla mesai/hafta tatili) | 15 | — (Localization) |
