...
## 1. Giriş
BingehOS'in üçüncü parti entegratörler ve müşterilerin kendi IT ekipleri tarafından genişletilebilmesi için kurulan platform katmanıdır.
...
* **Out-of-Process Plugins (Dış Sistem Eklentileri):**
  * Eklenti kendi sunucusunda çalışır. BingehOS ile iletişimini Webhook'lar ve Developer REST API'si üzerinden sağlar. (Önerilen güvenli entegrasyon yöntemi).
